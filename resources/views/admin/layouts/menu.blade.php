        <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
            <div class="sidebar-inner px-4 pt-3">
                <div
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-block">
                            ...
                            <a href="{{ asset('admin/pages/examples/sign-in.html') }}"
                ...
                <ul class="nav flex-column pt-3 pt-md-0">
                    <li class="nav-item">
                        <a href="{{ url('manage/dashboard') }}" class="nav-link d-flex align-items-center">
                            <span class="sidebar-icon">
                                <img src="{{ asset('admin/assets/img/brand/galaxy.svg') }}" height="40"
                                    width="40" alt="Volt Logo">
                            </span>
                            <span class="mt-1 ms-1 sidebar-text">Gadget Galaxy</span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a href="{{ url('manage/dashboard') }}" class="nav-link">
                            <span class="sidebar-icon">
                    ...
                    <li class="nav-item">
                        <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                            data-bs-toggle="collapse" data-bs-target="#sub-produk">
                            <span>
                                <span class="sidebar-icon">
                                    <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="multi-level collapse " role="list" id="sub-produk" aria-expanded="false">
                            <ul class="flex-column nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('manage/kategoriProduk') }}">
                                        <span class="sidebar-text">Kategori Produk</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="{{ url('manage/produk') }}">
                                        <span class="sidebar-text">Produk</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item ">
                        <a href="{{ url('manage/pesanan') }}" class="nav-link">
                            <span class="sidebar-icon">
                                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
